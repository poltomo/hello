---
layout: post
title:  "quickest way to extend pytorch: speeding up tensor expressions by hand"
date:   2024-05-20 03:13:00 -0700
---

Extending python with C libraries is very useful. Say there's something I want to do with torch tensors that Pytorch does not support; it can be much easier and faster to do the job on the raw float arrays. Instead of relying on pytorch's compiler, you can just do it yourself. If your backedoes not require
...
Why do this at all? Typically, you would just rely on the torch library and delegate
